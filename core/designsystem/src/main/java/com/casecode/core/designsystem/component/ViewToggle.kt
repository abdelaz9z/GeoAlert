...
/**
 * GeoAlert view toggle button with included trailing icon as well as compact and expanded
...
fun GeoAlertViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = GeoAlertViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        GeoAlertViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) GeoAlertIcons.ViewDay else GeoAlertIcons.ShortText,
 ...
 */
@Composable
private fun GeoAlertViewToggleButtonContent(
 ...
 */
object GeoAlertViewToggleDefaults {
    // TODO: File bug
