    ...
    Box(modifier = modifier) {
        val containerColor = if (followed) {
            ...
            MaterialTheme.colorScheme.surfaceVariant.copy(
                alpha = GeoAlertTagDefaults.UNFOLLOWED_TOPIC_TAG_CONTAINER_ALPHA,
            )
        }
        TextButton(
            onClick = onClick,
            ...
            colors = ButtonDefaults.textButtonColors(
                ...
                disabledContainerColor = MaterialTheme.colorScheme.onSurface.copy(
                    alpha = GeoAlertTagDefaults.DISABLED_TOPIC_TAG_CONTAINER_ALPHA,
                ),
            ),
        ) {
...
fun TagPreview() {
    GeoAlertTheme {
        GeoAlertTopicTag(followed = true, onClick = {}) {
