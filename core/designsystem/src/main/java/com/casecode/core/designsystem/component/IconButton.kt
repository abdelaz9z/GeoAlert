...
/**
 * GeoAlert toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
        ...
        colors = IconButtonDefaults.iconToggleButtonColors(
            ...
            disabledContainerColor = if (checked) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = GeoAlertIconButtonDefaults.DISABLED_ICON_BUTTON_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
fun IconButtonPreview() {
    GeoAlertTheme {
        GeoAlertIconToggleButton(
            checked = true,
            onCheckedChange = { },
            icon = {
                Icon(
                    imageVector = GeoAlertIcons.BookmarkBorder,
                    contentDescription = null,
                )
            },
            checkedIcon = {
                Icon(
                    imageVector = GeoAlertIcons.Bookmark,
                    contentDescription = null,
                )
            },
        )
 ...
 */
object GeoAlertIconButtonDefaults {
    // TODO: File bug
